...
if __name__ == "__main__":
    ...
    edit_menu.add_command(
        label="Search with Google...", command=Google, accelerator="Ctrl+E"
    )
    ...
    insert_menu.add_command(
        label="Date And Time", command=Date_and_time, accelerator="Ctrl+Shift+D"
    )
    ...
    format_menu.add_command(
        label="Highlight Text", command=Highlight, accelerator="Ctrl+W"
    )
    root.bind("<Control-w>", Shortcuts.Highlight)
    format_menu.add_command(
        label="Remove Format", command=No_Format, accelerator="Ctrl+Q"
    )
    ...
    personalize_menu.add_command(
        label="Background", command=Background, accelerator="Alt+X"
    )
    root.bind("<Alt-x>", Shortcuts.Background)
    personalize_menu.add_command(
        label="Text Colour", command=Text_colour, accelerator="Ctrl+F"
    )
    personalize_menu.add_separator()
    dark = IntVar()
    personalize_menu.add_checkbutton(
        label="Dark Mode", variable=dark, command=Dark_mode, accelerator="Alt+D"
    )
